...
Open the WireGuard GUI and click **Add Tunnel → Import tunnel(s) from file...**, then import `targets/shared/wg0.conf` from the test framework.
...
```sh
virsh -c qemu:///system snapshot-create-as win2k25 win2k25 \
