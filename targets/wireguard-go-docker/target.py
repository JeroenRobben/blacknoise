...
target = TestTarget(
    ...
    # Server (our side) , from targets/shared/server.conf
    ...
    # UDP echo service port
    echo_port=9000,

    preshared_key=None,

    capture_interface="wg-test-br",
)
